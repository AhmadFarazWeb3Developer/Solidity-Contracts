...
contract TokenMarketPlace is Ownable, ReentrancyGuard {
    ...
    constructor(address _pkbkToken) Ownable(msg.sender) {
...
// 50000000000000000000 total tokens in contract is transafered from pkbk token, this contract is just intermediatry
// 0xE48da25C9AA14AED02226AbF7EA865Cd23B226F7 : Address of this contract on sepolia testnet
